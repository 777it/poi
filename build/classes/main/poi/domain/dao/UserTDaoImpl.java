...
@javax.annotation.Generated(value = { "Doma", "2.16.0" }, date = "2017-11-17T08:00:57.516+0900")
public class UserTDaoImpl extends org.seasar.doma.internal.jdbc.dao.AbstractDao implements poi.domain.dao.UserTDao {
    ...
    private static final java.lang.reflect.Method __method6 = org.seasar.doma.internal.jdbc.dao.AbstractDao.getDeclaredMethod(poi.domain.dao.UserTDao.class, "update", poi.domain.entity.UserT.class);
    ...
    @Override
    public int update(poi.domain.entity.UserT entity) {
        entering("poi.domain.dao.UserTDaoImpl", "update", entity);
        try {
            if (entity == null) {
                throw new org.seasar.doma.DomaNullPointerException("entity");
            }
            org.seasar.doma.jdbc.query.AutoUpdateQuery<poi.domain.entity.UserT> __query = getQueryImplementors().createAutoUpdateQuery(__method6, poi.domain.entity._UserT.getSingletonInternal());
            ...
            int __result = __command.execute();
            __query.complete();
            exiting("poi.domain.dao.UserTDaoImpl", "update", __result);
            return __result;
        } catch (java.lang.RuntimeException __e) {
            throwing("poi.domain.dao.UserTDaoImpl", "update", __e);
            throw __e;
        }
    }
